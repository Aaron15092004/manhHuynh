<%-- 
    ...
    Created on : Mar 10, 2025, 4:46:34 PM
    Author     : Admin
--%>
...
<div class="modal fade modal-edit-contact" id="edit-event-modal" tabindex="-1" role="dialog" aria-labelledby="edit-modal-label" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <form action="events?action=edit" method="POST" enctype="multipart/form-data" id="editEventForm" onsubmit="return validateEventForm('editEventForm')">
