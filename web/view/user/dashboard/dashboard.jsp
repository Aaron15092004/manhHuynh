<%-- 
    Document   : dashboard
    Created on : Mar 16, 2025, 11:30:00 PM
    Author     : YourName
--%>
...
<html lang="en" dir="ltr">
    <head>
        ...
        <meta name="description" content="Harmoni - User Dashboard">

        <title>Harmoni - User Dashboard</title>
                        ...
                        <div class="content">
                            <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <span><i class="mdi mdi-chevron-right"></i></span>Dashboard</p>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-12">
                                <div class="card card-default">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <h4 class="mt-4 mb-3">My Events</h4>
                                        <p class="text-muted">You have created <strong>${totalEvents}</strong> events</p>
                                        <a href="${pageContext.request.contextPath}/user/events" class="btn btn-primary mt-3">View My Events</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-12">
                                <div class="card card-default">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <h4 class="mt-4 mb-3">My Tickets</h4>
                                        <p class="text-muted">You have purchased <strong>${totalTickets}</strong> tickets</p>
                                        <a href="${pageContext.request.contextPath}/user/tickets" class="btn btn-primary mt-3">View My Tickets</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-12">
                                <div class="card card-default">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <h4 class="mt-4 mb-3">My Registrations</h4>
                                        <p class="text-muted">You have <strong>${totalRegistrations}</strong> registrations</p>
                                        <a href="${pageContext.request.contextPath}/user/registrations" class="btn btn-primary mt-3">View Registrations</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="card card-default">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <table id="responsive-data-table" class="table">
                                                ...
                                                <tbody>
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            <c:forEach items="${userEvents}" var="e" end="4">
                                                                <tr>
                                                                    <td>${e.event_id}</td>
                                                                    ...
                                                                    <td>
                                                                        <img src="${pageContext.request.contextPath}${e.image}" style="height: 80px; width: auto;" alt="Event Image" />
                                                                    </td>
                                                                    <td>
                                        ...
                                        <div class="mt-3">
                                            <a href="${pageContext.request.contextPath}/user/events" class="btn btn-primary">View All Events</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card card-default">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table id="responsive-registration-table" class="table">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            <c:forEach items="${userRegistrations}" var="reg" end="4">
                                                                <tr>
                                        ...
                                        <div class="mt-3">
                                            <a href="${pageContext.request.contextPath}/user/registrations" class="btn btn-primary">View All Registrations</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
