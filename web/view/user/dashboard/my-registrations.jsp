<%-- 
    Document   : my-registrations
    Created on : Mar 16, 2025, 12:30:00 AM
    Author     : YourName
--%>
...
<html lang="en" dir="ltr">
    <head>
        ...
        <meta name="description" content="Harmoni - User Registrations">

        <title>Harmoni - My Registrations</title>
                        ...
                        <div class="content">
                            <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <span><i class="mdi mdi-chevron-right"></i></span>My Registrations</p>
                            </div>
                        </div>
