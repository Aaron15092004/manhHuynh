				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-12 col-sm-12">
						...
						<div class="event-details mb-80">
							...
							<div id="event-details-carousel" class="event-details-carousel owl-carousel owl-theme">
								<div class="item">
									<img src="${pageContext.request.contextPath}/assets/images/event/event-details-1.jpg" alt="Image_not_found">
								</div>
								<div class="item">
									<img src="${pageContext.request.contextPath}/assets/images/event/event-details-2.jpg" alt="Image_not_found">
								</div>
								<div class="item">
									<img src="${pageContext.request.contextPath}/assets/images/event/event-details-3.jpg" alt="Image_not_found">
								</div>
							</div>
									...
									<div id="day1" class="tab-pane fade in active show">
										...
										<div class="tab-content">
											<div id="day1hall1" class="tab-pane fade">
												<div class="hall-item clearfix">
													<div class="hall-image">
														<img src="${pageContext.request.contextPath}/assets/images/event/1.hall.png" alt="Image_not_found">
													</div>
											...
											<div id="day1hall2" class="tab-pane fade in active show">
												...
												<div class="hall-item clearfix">
													<div class="hall-image">
														<img src="${pageContext.request.contextPath}/assets/images/event/2.hall.png" alt="Image_not_found">
													</div>
													<div class="hall-content">
						...
						<div class="reviewer-comment-wrapper mb-30 clearfix">
							...
							<div class="comment-bar clearfix">
								<div class="admin-image">
									<img src="${pageContext.request.contextPath}/assets/images/admin.png" alt="Image_not_found">
								</div>
					...
					<div class="col-lg-4 col-md-12 col-sm-12">
						<div class="sidebar-section">
							...
							<div class="spacial-event-wrapper text-center" style="background-image: url('${pageContext.request.contextPath}/assets/images/spacial-event-bg.jpg');">
								<div class="overlay-black">
