...
/**
 * Servlet để xử lý các đăng ký của người dùng
 * @author YourName
 */
public class UserRegistrationServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // Forward đến trang my-registrations.jsp
        request.getRequestDispatcher("../view/user/dashboard/my-registrations.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect(request.getContextPath() + "/user/registrations");
    }
}